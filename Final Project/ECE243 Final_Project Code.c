...
void draw_pattern4(int x0, int y0, int colour, int goal_colour, int inside_goal_colour)
{
	...
	draw_goal(x0, y0+10+20+45, x0, y0+10+20+45+20, goal_colour, inside_goal_colour);
	draw_wall(x0, y0+10+20+45+20+45, x0, y0+10+20+45+20+45+20, colour);
	draw_wall(x0, y0+10+20+45+20+45+20+45, x0, y0+10+20+45+20+45+20+45+20, colour);
